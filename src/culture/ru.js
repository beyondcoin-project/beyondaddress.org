(function (translator) {
	translator.translations["ru"] = {
		...
		"paperlabelbitcoinaddress": "Адрес Beyondcoin кошелька:",
		...
		"footerlabelsig": "sig",
		"footerlabelcopyright1": "Копирайт beyondaddress.org.",
		...
		"detaillabelnote2": "Приложение Beyondcoin версии 0.6 и выше хранит ключи в сжатом формате. Это приложение также поддерживает импорт и экспорт приватных ключей командами importprivkey/dumpprivkey. Формат экспортированного ключа определяется кошельком, который сгенерировал адрес Биткоин.",
